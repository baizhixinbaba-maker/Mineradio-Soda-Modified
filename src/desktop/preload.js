...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  openSodaMusicLogin: (options) => ipcRenderer.invoke('soda-music-open-login', options || {}),
  createSodaMusicQr: (options) => ipcRenderer.invoke('soda-music-create-qr', options || {}),
  getSodaMusicQrLoginStatus: () => ipcRenderer.invoke('soda-music-qr-login-status'),
  getSodaMusicRuntimeStatus: () => ipcRenderer.invoke('soda-music-runtime-status'),
